...
export const PALABRAS_SILABAS = [
  ...
  // --- Dos sílabas, todas abiertas (las más fáciles) ---
  { silabas: ['ma', 'má'], emoji: '👩' },
  { silabas: ['pa', 'pá'], emoji: '👨' },
  { silabas: ['be', 'bé'], emoji: '👶' },
  { silabas: ['ni', 'ño'], emoji: '👦' },
  { silabas: ['ni', 'ña'], emoji: '👧' },
  { silabas: ['ca', 'sa'], emoji: '🏠' },
  { silabas: ['ca', 'ma'], emoji: '🛏️' },
  { silabas: ['me', 'sa'], emoji: '🍽️' },
  { silabas: ['si', 'lla'], emoji: '🪑' },
  { silabas: ['so', 'fá'], emoji: '🛋️' },
  { silabas: ['te', 'le'], emoji: '📺' },
  { silabas: ['ro', 'pa'], emoji: '👗' },
  { silabas: ['va', 'so'], emoji: '🥤' },
  { silabas: ['ta', 'za'], emoji: '☕' },
  { silabas: ['ve', 'la'], emoji: '🕯️' },
  { silabas: ['cu', 'bo'], emoji: '🧊' },
  { silabas: ['hi', 'lo'], emoji: '🧵' },
  { silabas: ['plu', 'ma'], emoji: '🪶' },
  { silabas: ['fo', 'to'], emoji: '📷' },
  { silabas: ['li', 'bro'], emoji: '📖' },
  { silabas: ['glo', 'bo'], emoji: '🎈' },
  { silabas: ['da', 'do'], emoji: '🎲' },
  { silabas: ['yo', 'yo'], emoji: '🪀' },
  { silabas: ['go', 'rra'], emoji: '🧢' },
  { silabas: ['co', 'che'], emoji: '🚗' },
  { silabas: ['mo', 'to'], emoji: '🏍️' },
  { silabas: ['rue', 'da'], emoji: '🛞' },
  { silabas: ['ci', 'ne'], emoji: '🎬' },
  { silabas: ['du', 'cha'], emoji: '🚿' },
  { silabas: ['o', 'jo'], emoji: '👁️' },
  { silabas: ['ma', 'no'], emoji: '✋' },
  { silabas: ['de', 'do'], emoji: '☝️' },
  { silabas: ['bo', 'ca'], emoji: '👄' },
  { silabas: ['ca', 'ra'], emoji: '😊' },
  { silabas: ['ga', 'to'], emoji: '🐱' },
  ...
  { silabas: ['po', 'llo'], emoji: '🐥' },
  { silabas: ['lu', 'na'], emoji: '🌙' },
  { silabas: ['no', 'che'], emoji: '🌃' },
  { silabas: ['nu', 'be'], emoji: '☁️' },
  { silabas: ['ra', 'yo'], emoji: '⚡' },
  { silabas: ['go', 'ta'], emoji: '💧' },
  { silabas: ['hu', 'mo'], emoji: '💨' },
  { silabas: ['fue', 'go'], emoji: '🔥' },
  { silabas: ['ho', 'ja'], emoji: '🍃' },
  { silabas: ['pi', 'no'], emoji: '🌲' },
  { silabas: ['ro', 'sa'], emoji: '🌹' },
  { silabas: ['pla', 'ya'], emoji: '🏖️' },
  { silabas: ['so', 'pa'], emoji: '🍲' },
  { silabas: ['que', 'so'], emoji: '🧀' },
  { silabas: ['le', 'che'], emoji: '🥛' },
  { silabas: ['hue', 'vo'], emoji: '🥚' },
  { silabas: ['pi', 'ña'], emoji: '🍍' },
  { silabas: ['pe', 'ra'], emoji: '🍐' },
  { silabas: ['fre', 'sa'], emoji: '🍓' },
  { silabas: ['u', 'va'], emoji: '🍇' },
  { silabas: ['co', 'co'], emoji: '🥥' },
  { silabas: ['ta', 'co'], emoji: '🌮' },
  { silabas: ['do', 'na'], emoji: '🍩' },
  ...
  // --- Tres sílabas, todas abiertas ---
  { silabas: ['za', 'pa', 'to'], emoji: '👟' },
  { silabas: ['pe', 'lo', 'ta'], emoji: '⚽' },
  { silabas: ['ca', 'mi', 'sa'], emoji: '👕' },
  { silabas: ['mo', 'chi', 'la'], emoji: '🎒' },
  { silabas: ['ma', 'le', 'ta'], emoji: '🧳' },
  { silabas: ['mu', 'ñe', 'ca'], emoji: '🪆' },
  { silabas: ['re', 'ga', 'lo'], emoji: '🎁' },
  { silabas: ['di', 'ne', 'ro'], emoji: '💰' },
  { silabas: ['mú', 'si', 'ca'], emoji: '🎵' },
  { silabas: ['gui', 'ta', 'rra'], emoji: '🎸' },
  { silabas: ['ra', 'que', 'ta'], emoji: '🎾' },
  { silabas: ['si', 're', 'na'], emoji: '🧜' },
  { silabas: ['ca', 'ba', 'llo'], emoji: '🐴' },
  { silabas: ['ga', 'lli', 'na'], emoji: '🐔' },
  { silabas: ['pa', 'lo', 'ma'], emoji: '🕊️' },
  { silabas: ['ca', 'me', 'llo'], emoji: '🐫' },
  { silabas: ['ba', 'lle', 'na'], emoji: '🐳' },
  { silabas: ['co', 'ne', 'jo'], emoji: '🐰' },
  { silabas: ['ji', 'ra', 'fa'], emoji: '🦒' },
  { silabas: ['to', 'ma', 'te'], emoji: '🍅' },
  { silabas: ['plá', 'ta', 'no'], emoji: '🍌' },
  { silabas: ['ce', 're', 'za'], emoji: '🍒' },
  { silabas: ['ce', 'bo', 'lla'], emoji: '🧅' },
  { silabas: ['ga', 'lle', 'ta'], emoji: '🍪' },
  { silabas: ['pa', 'le', 'ta'], emoji: '🍭' },
  { silabas: ['cho', 'ri', 'zo'], emoji: '🌭' },

  // --- Tres sílabas con alguna cerrada ---
  ...
  { silabas: ['ca', 'ra', 'me', 'lo'], emoji: '🍬' },
  { silabas: ['za', 'na', 'ho', 'ria'], emoji: '🥕' },
...
// Una sílaba es cerrada (o inversa) cuando termina en consonante: "sol", "car",
// "pas". Sirve para el interruptor que decide si estas palabras entran o no.
export const esSilabaCerrada = (silaba) => !/[aeiouáéíóúü]$/.test(silaba);
export const tieneSilabaCerrada = (palabra) => palabra.silabas.some(esSilabaCerrada);
